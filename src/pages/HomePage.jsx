  ...
  return (
    <section className="flex flex-col gap-5 md:flex-row">
      ...
      <div className="flex flex-col sm:hidden border max-h-[600px] overflow-y-scroll border-gray-300 text-xl rounded p-4 gap-3 flex-2 md:block">
        <h2 className="text-4xl font-bold capitalize">full-stack developer</h2>
        <p className="space-x-1">
        ...
        <p className="text-gray-500">700 9th Avenue SW, Calgary, AB T2P 3V4</p>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-gray-500 text-justify">
            ...
            investing in our employees and empowering them to develop themselves
            and their careers. Experience the challenges, rewards and
            opportunity of working for one of the world’s largest providers of
            products and services to the global energy industry.
          </p>
        </div>
      </div>
    </section>
